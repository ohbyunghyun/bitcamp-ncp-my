...
public class JdbcTeacherDao implements TeacherDao{
  ...
  public Teacher[] findAll() {
    try (Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery(
            "select teacher_id, name, tel, created_date, email, degree, school, major, wage from app_teacher order by teacher_id desc");) {
  ...
  public Teacher findByNo(int no) {
    ...
    try (Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery(
            "select teacher_id, name, tel, created_date, email, degree, school, major, wage from app_teacher where teacher_id=" + no)) {
