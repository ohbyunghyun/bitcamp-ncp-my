...
add constraint app_board_pk primary key (board_id),
...
add constraint app_student_pk primary key (student_id),
...
add constraint app_teacher_pk primary key (teacher_id),
