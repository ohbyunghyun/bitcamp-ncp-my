...
<jsp:useBean id="b1" class="bitcamp.myapp.vo.Board" scope="page"/>
<%-- 
위 태그의 자바 코드:
...
<jsp:useBean id="b2" class="bitcamp.myapp.vo.Board"/>

<jsp:useBean id="b3" class="bitcamp.myapp.vo.Board"/>

<%-- 객체의 setter 메서드를 호출하기 --%>
<jsp:setProperty name="b3" property="no" value="100"/>
<jsp:setProperty name="b3" property="content" value="내용입니다."/>
