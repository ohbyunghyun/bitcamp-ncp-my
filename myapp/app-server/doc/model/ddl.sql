...
CREATE TABLE lms_class (
  ...
  edu_center_id INTEGER     NOT NULL COMMENT '센터번호', -- 센터번호
...
ALTER TABLE lms_edu_center
  MODIFY COLUMN edu_center_id INTEGER NOT NULL AUTO_INCREMENT COMMENT '센터번호';
...
CREATE TABLE lms_class_photo (
  class_photo_id  INTEGER      NOT NULL COMMENT '강의실사진 번호', -- 강의실사진 번호
  photo_path      VARCHAR(255) NOT NULL COMMENT '사진', -- 사진
  origin_filename VARCHAR(50)  NOT NULL COMMENT '원래사진파일명', -- 원래사진파일명
...
ALTER TABLE lms_class_photo
  ...
  PRIMARY KEY (
  class_photo_id -- 강의실사진 번호
  );

ALTER TABLE lms_class_photo
  MODIFY COLUMN class_photo_id INTEGER NOT NULL AUTO_INCREMENT COMMENT '강의실사진 번호';
